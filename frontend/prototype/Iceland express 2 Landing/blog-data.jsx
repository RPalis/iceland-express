...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "list", items: ["F35 Kjölur — the most accessible highland route. Gravel, gentle river crossings, open mid-June. Good for first-timers.", "F208 Fjallabak — past Landmannalaugar and its rhyolite mountains. The colours are otherworldly.", "F26 Sprengisandur — Iceland's wild interior crossing. Remote, dramatic, requires experience.", "F88 to Askja — ends at a caldera lake where you can swim in geothermal water surrounded by a volcanic desert.", "F910 Öskjuvatn — the highest point in Iceland accessible by car. Opens late July, closes early September."] },
