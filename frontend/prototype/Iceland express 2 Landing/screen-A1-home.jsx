// screen-A1-home.jsx — A1 Homepage Search
// Figma: A1-Homepage-Search--Default-state
  ...
  return (
    <div className="flow">
      ...
      <section className="shell" style={{ marginTop: 64 }}>
        <SectionHdr title="Why book with Iceland Express" subtitle="Value over the lowest sticker price — every time." style={{ marginBottom: 24 }} />
